...
### `bonemealSuccessProbability` - 骨粉催熟树苗概率

* **说明**: 修改骨粉成功催熟树苗的概率。

### `foliageGenerate` - 树叶生成

* **说明**: 关闭后，树苗在生长为树时将不会生成树叶。

### `beeDecoratorProbability` - 蜂巢装饰概率

* **说明**: 调整树木生成蜂巢的概率。对所有可能生成蜂巢的树木生效。设置为 **-1** 时使用原版默认概率。
