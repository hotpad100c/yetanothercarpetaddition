...
public class PieChartRenderer {
    //#if MC >= 260200
    //$$ private static final Map<Item, Block> DEFAULTS = Map.ofEntries(Map.entry(Items.DANDELION, Blocks.WOOL.yellow()), Map.entry(Items.POPPY, Blocks.WOOL.red()), Map.entry(Items.BLUE_ORCHID, Blocks.WOOL.lightBlue()), Map.entry(Items.ALLIUM, Blocks.WOOL.magenta()), Map.entry(Items.AZURE_BLUET, Blocks.SNOW_BLOCK), Map.entry(Items.RED_TULIP, Blocks.WOOL.red()), Map.entry(Items.ORANGE_TULIP, Blocks.WOOL.orange()), Map.entry(Items.WHITE_TULIP, Blocks.SNOW_BLOCK), Map.entry(Items.PINK_TULIP, Blocks.WOOL.pink()), Map.entry(Items.OXEYE_DAISY, Blocks.SNOW_BLOCK), Map.entry(Items.CORNFLOWER, Blocks.WOOL.blue()), Map.entry(Items.WITHER_ROSE, Blocks.WOOL.black()), Map.entry(Items.LILY_OF_THE_VALLEY, Blocks.WOOL.white()), Map.entry(Items.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK), Map.entry(Items.RED_MUSHROOM, Blocks.RED_MUSHROOM_BLOCK), Map.entry(Items.STICK, Blocks.OAK_PLANKS), Map.entry(Items.GOLD_INGOT, Blocks.GOLD_BLOCK), Map.entry(Items.IRON_INGOT, Blocks.IRON_BLOCK), Map.entry(Items.DIAMOND, Blocks.DIAMOND_BLOCK), Map.entry(Items.NETHERITE_INGOT, Blocks.NETHERITE_BLOCK), Map.entry(Items.SUNFLOWER, Blocks.WOOL.yellow()), Map.entry(Items.LILAC, Blocks.WOOL.magenta()), Map.entry(Items.ROSE_BUSH, Blocks.WOOL.red()), Map.entry(Items.PEONY, Blocks.WOOL.pink()), Map.entry(Items.CARROT, Blocks.WOOL.orange()), Map.entry(Items.APPLE, Blocks.WOOL.red()), Map.entry(Items.WHEAT, Blocks.HAY_BLOCK), Map.entry(Items.PORKCHOP, Blocks.WOOL.pink()), Map.entry(Items.RABBIT, Blocks.WOOL.pink()), Map.entry(Items.CHICKEN, Blocks.DYED_TERRACOTTA.white()), Map.entry(Items.BEEF, Blocks.NETHERRACK), Map.entry(Items.ENCHANTED_GOLDEN_APPLE, Blocks.GOLD_BLOCK), Map.entry(Items.COD, Blocks.DYED_TERRACOTTA.white()), Map.entry(Items.SALMON, Blocks.ACACIA_PLANKS), Map.entry(Items.ROTTEN_FLESH, Blocks.WOOL.brown()), Map.entry(Items.PUFFERFISH, Blocks.DYED_TERRACOTTA.yellow()), Map.entry(Items.TROPICAL_FISH, Blocks.WOOL.orange()), Map.entry(Items.POTATO, Blocks.DYED_TERRACOTTA.white()), Map.entry(Items.MUTTON, Blocks.WOOL.red()), Map.entry(Items.BEETROOT, Blocks.NETHERRACK), Map.entry(Items.MELON_SLICE, Blocks.MELON), Map.entry(Items.POISONOUS_POTATO, Blocks.SLIME_BLOCK), Map.entry(Items.SPIDER_EYE, Blocks.NETHERRACK), Map.entry(Items.GUNPOWDER, Blocks.WOOL.gray()), Map.entry(Items.TURTLE_SCUTE, Blocks.WOOL.lime()),
    //#else
    ...
    //#endif
            ...
            //#endif
            //#if MC >= 260200
            //$$ Map.entry(Items.FEATHER, Blocks.WOOL.white()), Map.entry(Items.FLINT, Blocks.WOOL.black()), Map.entry(Items.LEATHER, Blocks.SPRUCE_PLANKS), Map.entry(Items.GLOWSTONE_DUST, Blocks.GLOWSTONE), Map.entry(Items.PAPER, Blocks.WOOL.white()), Map.entry(Items.BRICK, Blocks.BRICKS), Map.entry(Items.INK_SAC, Blocks.WOOL.black()), Map.entry(Items.SNOWBALL, Blocks.SNOW_BLOCK), Map.entry(Items.WATER_BUCKET, Blocks.WATER), Map.entry(Items.LAVA_BUCKET, Blocks.LAVA), Map.entry(Items.MILK_BUCKET, Blocks.WOOL.white()), Map.entry(Items.CLAY_BALL, Blocks.CLAY), Map.entry(Items.COCOA_BEANS, Blocks.COCOA), Map.entry(Items.BONE, Blocks.BONE_BLOCK), Map.entry(Items.COD_BUCKET, Blocks.DYED_TERRACOTTA.brown()), Map.entry(Items.PUFFERFISH_BUCKET, Blocks.DYED_TERRACOTTA.yellow()), Map.entry(Items.SALMON_BUCKET, Blocks.DYED_TERRACOTTA.pink()), Map.entry(Items.TROPICAL_FISH_BUCKET, Blocks.DYED_TERRACOTTA.orange()), Map.entry(Items.SUGAR, Blocks.WOOL.white()), Map.entry(Items.BLAZE_POWDER, Blocks.GOLD_BLOCK), Map.entry(Items.ENDER_PEARL, Blocks.WARPED_PLANKS), Map.entry(Items.NETHER_STAR, Blocks.DIAMOND_BLOCK), Map.entry(Items.PRISMARINE_CRYSTALS, Blocks.SEA_LANTERN), Map.entry(Items.PRISMARINE_SHARD, Blocks.PRISMARINE), Map.entry(Items.RABBIT_HIDE, Blocks.OAK_PLANKS), Map.entry(Items.CHORUS_FRUIT, Blocks.PURPUR_BLOCK), Map.entry(Items.SHULKER_SHELL, Blocks.SHULKER_BOX), Map.entry(Items.NAUTILUS_SHELL, Blocks.BONE_BLOCK), Map.entry(Items.HEART_OF_THE_SEA, Blocks.CONDUIT), Map.entry(Items.HONEYCOMB, Blocks.HONEYCOMB_BLOCK), Map.entry(Items.NAME_TAG, Blocks.BONE_BLOCK), Map.entry(Items.TOTEM_OF_UNDYING, Blocks.DYED_TERRACOTTA.yellow()), Map.entry(Items.TRIDENT, Blocks.PRISMARINE), Map.entry(Items.GHAST_TEAR, Blocks.WOOL.white()), Map.entry(Items.PHANTOM_MEMBRANE, Blocks.BONE_BLOCK), Map.entry(Items.EGG, Blocks.BONE_BLOCK), Map.entry(Items.COPPER_INGOT, Blocks.COPPER_BLOCK.weathering().pick(net.minecraft.world.level.block.WeatheringCopper.WeatherState.UNAFFECTED)), Map.entry(Items.AMETHYST_SHARD, Blocks.AMETHYST_BLOCK));
            //#else
