...
public abstract class ConstantScrollableWidget extends AbstractWidget implements Renderable, GuiEventListener {
    ...
    //#else
    private static final WidgetSprites TEXT_FIELD_TEXTURES = new WidgetSprites(ResourceLocation.fromNamespaceAndPath("minecraft","widget/text_field"), ResourceLocation.fromNamespaceAndPath("minecraft","widget/text_field_highlighted"));
