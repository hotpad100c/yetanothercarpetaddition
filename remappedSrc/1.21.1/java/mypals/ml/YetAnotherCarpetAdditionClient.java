    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (carpetRulesKeyBind.consumeClick()) {
                Minecraft.getInstance().player.sendSystemMessage(Component.literal("Requesting rules now！")
                        //#if MC >= 12102
                        //$$ , false
                        //#endif
                );
        ...
        ClientPlayNetworking.registerGlobalReceiver(RulesPacketPayload.ID,
                ...
                //#endif
                    ...
                    chachedCategories.addAll(chachedRules.stream()
                            ...
                            .distinct().toList());
                    client.player.sendSystemMessage(Component.literal("Received " + chachedRules.size() + " rules from server！")
                            //#if MC >= 12102
                            //$$ , false
                            //#endif
                    );
