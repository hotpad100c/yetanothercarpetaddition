...
public abstract class ConstantScrollableWidget extends AbstractWidget implements Renderable, GuiEventListener {
    ...
    //#else
    private static final WidgetSprites TEXT_FIELD_TEXTURES = new WidgetSprites(ResourceLocation.tryBuild("minecraft","widget/text_field"), ResourceLocation.tryBuild("minecraft","widget/text_field_highlighted"));
    private static final ResourceLocation SCROLLER_TEXTURE = ResourceLocation.tryBuild("minecraft","widget/scroller");
    //#endif
